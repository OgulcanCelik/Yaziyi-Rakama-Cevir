...
public class Converter {
	...
	public static List<String> allowedStrings = Arrays.asList("bir", "iki", "üç", "dört", "beþ", "altý", "yedi",
			"sekiz", "dokuz", "on", "yirmi", "otuz", "kýrk", "elli", "altmýþ", "yetmiþ", "seksen", "doksan", "yüz",
			"bin", "milyon", "milyar");
	...
	public static void main(String args[]) {
		...
		System.out.println("Yazýyla bir sayý girin, çýkýþ için q:");
		Scanner scan = new Scanner(System.in);
		String inputString = scan.nextLine();
		while (!inputString.equals("q")) {
			System.out.println(inputString);
			String dummy = "yüz beþbindokuz";
			...
			System.out.println("Yazýyla bir sayý girin:");
